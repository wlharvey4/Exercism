...
#+Author:Pinecone062
#+Date:Last updated 2020-12-03 07:12
#+Macro: version Version 0.5.40
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+header: :mkdirp yes :tangle functional/twelve-days/common-lisp/README.md
#+begin_src markdown
# Twelve Days
...
#+header: :mkdirp yes :tangle functional/twelve-days/common-lisp/.exercism/metadata
#+begin_src js
  {
      "track":"common-lisp",
...
#+header: :mkdirp yes :tangle functional/common-lisp/twelve-days/twelve-days.lisp
#+begin_src lisp
(in-package #:cl-user)
...
#+begin_src sh
ccl -Q -l twelve-days-test.lisp
#+end_src

*** Common Lisp Twelve Days Tests
#+header: :mkdirp yes :tangle common-lisp/twelve-days/twelve-days-tests.lisp
#+begin_src lisp
(ql:quickload "lisp-unit")

...
#+Author:Pinecone062
#+Date:Last updated 2020-11-12 19:57
#+Macro: version Version 0.5.23
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+begin_src sh :tangle common-lisp/roman-numerals :mkdirp yes
exercism download --exercise=roman-numerals --track=common-lisp
#+end_src

#+RESULTS:
: /usr/local/dev/programming/Exercism/common-lisp/roman-numerals

**** Common Lisp Roman Numerals Upload Script
#+begin_src lisp
exercism submit common-lisp/roman-numerals/roman-numerals.lisp
#+end_src
#+begin_src js :tangle common-lisp/roman-numerals/.exercism/metadata.json :mkdirp yes

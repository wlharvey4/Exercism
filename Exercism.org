...
#+Author:Pinecone062
#+Date:Last updated 2019-05-20 09:03
...
#+BEGIN_SRC :tangle perl5 :mkdirp yes
# Hello World
...
#+BEGIN_SRC perl :tangle perl5/hello-world/lib/HelloWorld.pm :mkdirp yes
...
#+BEGIN_SRC perl :tangle perl5/hello-world/t/hello-world.t :mkdirp yes
#!/usr/bin/env perl
use strict;
use warnings;
...
#+BEGIN_SRC :tangle perl5/two-fer/README.md
# Two Fer
...
#+BEGIN_SRC perl :tangle perl5/two-fer/lib/TwoFer.pm :mkdirp yes
package TwoFer;
use strict;
use warnings;
use Exporter 'import';
...
*** Perl5 Two Fer Test
#+perl5-two-fer-test
#+BEGIN_SRC perl :tangle perl5/two-fer/t/two-fer.t :mkdirp yes
#!/usr/bin/env perl
use strict;
use warnings;
...
: t/two-fer.t .. ok
: All tests successful.
: Files=1, Tests=4,  0 wallclock secs ( 0.02 usr  0.00 sys +  0.04 cusr  0.00 csys =  0.06 CPU)
: Result: PASS
...
BASE_DIR := ~/Dev/Programming/Languages/Exercism
LANGUAGES = python perl5
HTML_SRC = *.html
TEXINFO_SRC = *.{texi,info}
...
.phony : dist-clean
dist-clean :
	cd $(BASE_DIR) && rm -vrf $(LANGUAGES) README.md

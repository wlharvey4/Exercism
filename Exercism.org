...
#+Author:Pinecone062
#+Date:Last updated 2019-05-13 12:02
* Exercism Home
...
#+begin_src :tangle Python/Readme.md
...
#+name:Python-Hello_World-Readme
# Hello World
...
: rootdir: /usr/local/dev/programming/Exercism/python/hello-world
: collected 1 item
: 
...
#+begin_src python :tangle python/two-fer/two_fer.py

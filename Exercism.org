...
#+Author:Pinecone062
#+Date:Last updated 2019-05-28 10:58
...
emacs -batch -l ert -l two-fer-test3.el -f ert-run-tests-batch-and-exit 2>&1
#+end_src

#+RESULTS: elisp-two-fer-run-tests
: Loading /Users/pine/Dev/Programming/Languages/Exercism/elisp/two-fer/two-fer.el (source)...
: Running 3 tests (2019-05-28 10:57:28-0700)
:    passed  1/3  a-name-given
:    passed  2/3  another-name-given
:    passed  3/3  no-name-given
: 
: Ran 3 tests, 3 results as expected (2019-05-28 10:57:28-0700)
: 
...
LANGUAGES = javascript python perl5 ocaml bash elisp
HTML_SRC = *.html

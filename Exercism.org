...
#+Author:Pinecone062
#+Date:Last updated 2019-07-24 23:34
#+Macro: version Version 0.4.34
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
(* type orbital_period_assoc = (planet * period) *)

let earth_orbital_period = 365.25
...
let age_on_earth s =
  (Float.of_int s) /. 60. /. 60. /. 24. /. earth_orbital_period

let age_on pl sec =
  (Base.List.Assoc.find_exn orbital_periods_assoc ~equal:Base.Poly.equal pl) *.
  (age_on_earth sec)
#+end_src

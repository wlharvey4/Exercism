...
#+Author:Pinecone062
#+Date:Last updated 2020-12-08 08:17
#+Macro: version Version 0.5.44
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+begin_src lisp
  ...
  return the string."
    (setq song (format nil +BEGINNING+ day (gift day))))

  (defun one-iteration (num)
    "Given a number representing a start day, run through all of the
  iterations down to one."
    (let ((song (beginning-day num))
          (_and ""))
      (do ((cur-day (1- num) (1- cur-day)))
          ((zerop cur-day) song)

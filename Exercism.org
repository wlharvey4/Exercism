...
#+Author:Pinecone062
#+Date:Last updated 2019-08-20 11:22
#+Macro: version Version 0.4.47
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
PASS ./difference-of-squares.test.ts
  Squares
    up to 5
      ✓ gets the square of sum (3ms)
      ○ skipped gets the sum of squares
      ○ skipped gets the difference
    up to 10
      ○ skipped gets the square of sum
      ○ skipped gets the sum of squares
      ○ skipped gets the difference
    up to 100
      ○ skipped gets the square of sum

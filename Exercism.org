...
#+Author:Pinecone062
#+Date:Last updated 2019-07-02 19:12
#+Macro: version Version 0.4.14
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+begin_src sh
exercism submit python/pangram/pangram.py :mkdirp yes
#+end_src

*** Python Pangram Solution Code
#+name:python-pangram-solution
#+begin_src py -n :tangle python/pangram/pangram.py
...
#+begin_src emacs-lisp :tangle elisp/hamming/hamming.el
  ...
  (defun calc-hamming (str1 str2)
    "Recursively calculate the hamming distance between STR1 and STR2."
    (if (not (zerop (length str1)))
        (+ (if (char-equal (aref str1 0) (aref str2 0))
               0
             1)
           (calc-hamming (substring str1 1) (substring str2 1)))
      0))
...
#+begin_src js :tangle elisp/hamming/.exercism/matadata.json :exports none
  {
      "track":"elisp",
      "exercise":"hamming",

...
#+Author:Pinecone062
#+Date:Last updated 2019-08-20 10:49
#+Macro: version Version 0.4.46
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+RESULTS: typescript-difference-of-squares-download-script
: /usr/local/dev/programming/Languages/Exercism/typescript/difference-of-squares
...
#+header: :exports none :mkdirp yes
#+begin_src js :tangle typescript/difference-of-squares/.exercism/meatadata.json
  {
      "track":"typescript",

...
#+Author:Pinecone062
#+Date:Last updated 2019-05-15 12:30
* Exercism Home
...
Config dir:                       /Users/lolh/.config/exercism
Token:         (-t, --token)      b4b5ab41-b448-4762-a5ce-452ccd2eff08
Workspace:     (-w, --workspace)  /usr/local/dev/programming/Exercism
...
#+begin_src python :tangle python/high-scores/high_scores.py
...
#+begin_src python :tangle python/high-scores/high_scores_test.py
import unittest
...
python -m pytest high_score_test.py
#+end_src

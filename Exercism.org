...
#+Author:Pinecone062
#+Date:Last updated 2020-10-20 21:33
#+Macro: version Version 0.5.3
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
#+begin_src sh :results output :exports never
exercism submit common-lisp/two-fer/two-fer.lisp
#+end_src
...
#+begin_src lisp :tangle common-lisp/two-fer/two-fer.lisp
  ...
  (defun twofer (&optional name)
    (if (null name)
        ...
        (print (format nil "One for ~A, one for me." name))))
#+end_src

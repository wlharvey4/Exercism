...
#+Author:Pinecone062
#+Date:Last updated 2019-06-25 20:16
#+Macro: version Version 0.4.12
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
function isLeapYear(year : number) : boolean {
    ...
    let div_4   : boolean = !(year % 4),
        div_100 : boolean = !(year % 100),
        div_400 : boolean = !(year % 400);

    return div_4 && !(!div_400 && div_100);
}

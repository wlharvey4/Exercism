...
#+Author:Pinecone062
#+Date:Last updated 2019-08-03 00:06
#+Macro: version Version 0.4.41
{{{title}}} {{{version}}} {{{date}}}
* Exercism Home
:PROPERTIES:
:unnumbered: t
...
: /Users/pine/Dev/Programming/Languages/Exercism/typescript/rna-transcription
...
**** TypeScript RNA Transcription Run Tests Script
#+name:typescript-rna-transcription-run-tests
#+header: :dir typescript/rna-transcription
#+header: :results outuput :exports results
#+begin_src sh
yarn test
#+end_src

#+RESULTS: typescript-rna-transcription-run-tests
...
#+begin_src markdown :tangle typescript/rna-transcription/README.md
# RNA Transcription
...
class Transcriptor {
    ...
    toRna( dna:DNAStr ): RNAStr {
        // Your code here
        return dna.split('').reduce((c,n) => c.concat(Transcriptor.COMPLEMENT[n]),'')
    }
}
